...
function buildPrompt({ author, title, url, text, images }) {
  ...
  return [
    ...
    '}',
    'Rules:',
    '- points SHOULD contain between 1 and 15 items. Provide the most valuable insights.',
    ...
    '- CRITICAL: If multiple high-quality images are provided, use them as dedicated insights. For an image-focused insight, provide a relevant caption in the "heading" field and assign the image URL to the "image" field.',
...
async function summarizeBatchWithGemini(articles) {
  ...
  const batchPrompt = [
    ...
    '- Each object should have between 1 and 15 points.',
    '- CRITICAL: If multiple high-quality images are provided for an article, use them as dedicated insights. For an image-focused insight, provide a relevant caption in the "heading" field and assign the image URL to the "image" field.',
